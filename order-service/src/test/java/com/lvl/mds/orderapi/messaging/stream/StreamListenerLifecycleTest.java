package com.lvl.mds.orderapi.messaging.stream;
...
class StreamListenerLifecycleTest {
	...
	private static final Consumer CONSUMER = Consumer.from("order-service-group", "order-service-1");
	private static final StreamOffset<String> OFFSET = StreamOffset.create("order-results-stream", ReadOffset.lastConsumed());
